...
> (`SPEC_VERSION`, currently 1.2). This repository vendors that header at
...
**Version**: 2.0 (superseded — unrelated to duck_block `SPEC_VERSION`, now 1.2;
the duck_block line was renumbered from the retired internal 6.x, so 1.2 here is
NEWER than 6.6, not older)
**Status**: Historical
