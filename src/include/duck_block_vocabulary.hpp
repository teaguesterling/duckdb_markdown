...
// reader cannot reach. scripts/check_duck_block_vocabulary.py verifies this line
// against the header at that sha, so a stamp left stale is a failure, not a note.
